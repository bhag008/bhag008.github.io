...
// race（種族）: "dragon"（ドラゴン） | "demon"（デーモン） | "fairy"（フェアリー） | undefined（無種族）
...
export const STANDARD_CARDS = [
  ...
  { id: "std_lightning", name: "稲妻", emoji: "⚡", cost: 4, type: "spell", text: "敵ミニオンに7ダメージ", effect: { type: "damage", value: 7, target: "select_monster" } },
  { id: "std_ogre", name: "岩のオーガ", emoji: "🗿", cost: 4, type: "minion", atk: 4, hp: 6, keywords: ["taunt"], text: "挑発" },

  { id: "std_dragonet", name: "若き竜", emoji: "🐉", cost: 5, type: "minion", atk: 5, hp: 5, keywords: [], race: "dragon", text: "" },
  ...
  { id: "std_meteor", name: "隕石落とし", emoji: "☄️", cost: 6, type: "spell", text: "敵ミニオンに9ダメージ", effect: { type: "damage", value: 9, target: "select_monster" } },
...
export const EXPANSION_CARDS = {
  flame: [
    ...
    { id: "fl_c3", name: "小竜", emoji: "🐲", cost: 2, type: "minion", atk: 2, hp: 1, keywords: ["charge"], race: "dragon", rarity: "common", set: "flame", text: "速攻" },
    ...
    { id: "fl_r6", name: "竜の咆哮", emoji: "🐉", cost: 5, type: "minion", atk: 5, hp: 4, keywords: [], race: "dragon", rarity: "rare", set: "flame", text: "戦場に出た時: 敵に2ダメージ", battlecry: { type: "damage", value: 2, target: "enemy_face" } },
    // epic
    { id: "fl_e1", name: "灼熱の悪魔", emoji: "😈", cost: 5, type: "minion", atk: 5, hp: 5, keywords: [], race: "demon", rarity: "epic", set: "flame", text: "戦場に出た時: 対象に3ダメージ", battlecry: { type: "damage", value: 3, target: "select" } },
    ...
    // legendary
    { id: "fl_l1", name: "古代の紅竜アルカディオン", emoji: "🐲", cost: 8, type: "minion", atk: 8, hp: 8, keywords: ["taunt", "charge"], race: "dragon", rarity: "legendary", set: "flame", text: "挑発・速攻。戦場に出た時: 敵に4ダメージ", battlecry: { type: "damage", value: 4, target: "enemy_face" } },
  ...
  abyss: [
    // common
    { id: "ab_c1", name: "小悪魔", emoji: "👹", cost: 1, type: "minion", atk: 1, hp: 2, keywords: [], race: "demon", rarity: "common", set: "abyss", text: "戦場に出た時: 自分に1ダメージを与え、カードを1枚引く", battlecry: { type: "self_damage_draw", damage: 1, draw: 1, target: "none" } },
    ...
    { id: "ab_c6", name: "魂喰らいの犬", emoji: "🐕‍🦺", cost: 3, type: "minion", atk: 3, hp: 2, keywords: ["lifesteal"], race: "demon", rarity: "common", set: "abyss", text: "吸血" },
    ...
    { id: "ab_c8", name: "地獄の番犬", emoji: "🐺", cost: 4, type: "minion", atk: 5, hp: 4, keywords: ["taunt"], race: "demon", rarity: "common", set: "abyss", text: "挑発" },
    // rare
    ...
    { id: "ab_r6", name: "深淵の使者", emoji: "😈", cost: 5, type: "minion", atk: 4, hp: 5, keywords: ["lifesteal"], race: "demon", rarity: "rare", set: "abyss", text: "吸血。戦場に出た時: 敵に2ダメージ", battlecry: { type: "damage", value: 2, target: "enemy_face" } },
    // epic
    { id: "ab_e1", name: "地獄の使い魔統率者", emoji: "👺", cost: 4, type: "minion", atk: 3, hp: 3, keywords: [], race: "demon", rarity: "epic", set: "abyss", text: "戦場に出た時: 1/1の小悪魔を3体呼び出す", battlecry: { type: "summon_token", token: "imp_token", count: 3, target: "none" } },
    ...
    { id: "ab_e3", name: "深淵の恐怖", emoji: "👹", cost: 7, type: "minion", atk: 7, hp: 7, keywords: ["taunt", "lifesteal"], race: "demon", rarity: "epic", set: "abyss", text: "挑発・吸血" },
    ...
    // legendary
    { id: "ab_l1", name: "深淵の魔王ザガレス", emoji: "😈", cost: 8, type: "minion", atk: 7, hp: 7, keywords: ["lifesteal"], race: "demon", rarity: "legendary", set: "abyss", text: "吸血。戦場に出た時: 自分に3ダメージを与えてカードを3枚引き、自身を除くすべてのモンスターに3ダメージ", battlecry: { type: "pact_nuke", selfDamage: 3, draw: 3, boardDamage: 3, target: "none" } },
    { id: "ab_l2", name: "業魔の門番モラクス", emoji: "👹", cost: 7, type: "minion", atk: 6, hp: 7, keywords: ["taunt"], race: "demon", rarity: "legendary", set: "abyss", text: "挑発。戦場に出た時: 相手の手札をランダムに2枚捨てさせる", battlecry: { type: "discard_random_enemy", count: 2, target: "none" } },
  ],
  fairy: [
    // common
    ...
    { id: "fa_c4", name: "双子の妖精", emoji: "🧚", cost: 2, type: "minion", atk: 1, hp: 1, keywords: [], race: "fairy", rarity: "common", set: "fairy", text: "戦場に出た時: 1/1の妖精のかけらを1体呼び出す", battlecry: { type: "summon_token", token: "fairy_token", count: 1, target: "none" } },
    { id: "fa_c5", name: "妖精の護符", emoji: "🔮", cost: 1, type: "spell", rarity: "common", set: "fairy", text: "対象を3回復", effect: { type: "heal", value: 3, target: "select" } },
    { id: "fa_c6", name: "群れの妖精", emoji: "🧚", cost: 3, type: "minion", atk: 1, hp: 1, keywords: [], race: "fairy", rarity: "common", set: "fairy", text: "戦場に出た時: 他の妖精の数だけ+1/+1", battlecry: { type: "buff_self_per_race_count", race: "fairy", atkPerAlly: 1, hpPerAlly: 1, target: "none" } },
    { id: "fa_c7", name: "妖精の盾", emoji: "🛡️", cost: 3, type: "minion", atk: 0, hp: 4, keywords: ["taunt"], race: "fairy", rarity: "common", set: "fairy", text: "挑発" },
    { id: "fa_c8", name: "妖精の祝福", emoji: "🌸", cost: 3, type: "spell", rarity: "common", set: "fairy", text: "自分の妖精全体に+1/+1を付与", effect: { type: "buff_all_friendly_race", race: "fairy", atk: 1, hp: 1, target: "none" } },
    // rare
    { id: "fa_r1", name: "妖精女王の使者", emoji: "🧚", cost: 3, type: "minion", atk: 2, hp: 2, keywords: [], race: "fairy", rarity: "rare", set: "fairy", text: "戦場に出た時: 1/1の妖精のかけらを2体呼び出す", battlecry: { type: "summon_token", token: "fairy_token", count: 2, target: "none" } },
    { id: "fa_r2", name: "百花の妖精", emoji: "🌺", cost: 4, type: "minion", atk: 2, hp: 3, keywords: [], race: "fairy", rarity: "rare", set: "fairy", text: "戦場に出た時: 他の妖精の数だけ+2/+1", battlecry: { type: "buff_self_per_race_count", race: "fairy", atkPerAlly: 2, hpPerAlly: 1, target: "none" } },
    { id: "fa_r3", name: "妖精の大群", emoji: "🍄", cost: 4, type: "spell", rarity: "rare", set: "fairy", text: "1/1の妖精のかけらを3体呼び出す", effect: { type: "summon_token", token: "fairy_token", count: 3, target: "none" } },
    { id: "fa_r4", name: "妖精森の番人", emoji: "🌳", cost: 5, type: "minion", atk: 3, hp: 6, keywords: ["taunt"], race: "fairy", rarity: "rare", set: "fairy", text: "挑発" },
    { id: "fa_r5", name: "妖精郷の光", emoji: "🌟", cost: 5, type: "spell", rarity: "rare", set: "fairy", text: "自分の妖精全体に+2/+2を付与", effect: { type: "buff_all_friendly_race", race: "fairy", atk: 2, hp: 2, target: "none" } },
    { id: "fa_r6", name: "踊る妖精姫", emoji: "💃", cost: 4, type: "minion", atk: 1, hp: 1, keywords: ["charge"], race: "fairy", rarity: "rare", set: "fairy", text: "速攻。戦場に出た時: 他の妖精の数だけ+1/+1", battlecry: { type: "buff_self_per_race_count", race: "fairy", atkPerAlly: 1, hpPerAlly: 1, target: "none" } },
    // epic
    { id: "fa_e1", name: "妖精王の玉座", emoji: "👑", cost: 5, type: "spell", rarity: "epic", set: "fairy", text: "自分の妖精の数だけカードを引く（最大5枚）", effect: { type: "draw_per_race_count", race: "fairy", cap: 5, target: "none" } },
    { id: "fa_e2", name: "大妖精", emoji: "🧚‍♀️", cost: 6, type: "minion", atk: 3, hp: 4, keywords: [], race: "fairy", rarity: "epic", set: "fairy", text: "戦場に出た時: 1/1の妖精のかけらを2体呼び出し、他の妖精の数だけ+1/+1", battlecry: { type: "summon_token_and_buff_self", token: "fairy_token", count: 2, race: "fairy", atkPerAlly: 1, hpPerAlly: 1, target: "none" } },
    { id: "fa_e3", name: "満開の楽園", emoji: "🌷", cost: 6, type: "spell", rarity: "epic", set: "fairy", text: "自分の妖精全体に+3/+3を付与", effect: { type: "buff_all_friendly_race", race: "fairy", atk: 3, hp: 3, target: "none" } },
    { id: "fa_e4", name: "妖精郷の守護者", emoji: "🌲", cost: 7, type: "minion", atk: 5, hp: 7, keywords: ["taunt"], race: "fairy", rarity: "epic", set: "fairy", text: "挑発。戦場に出た時: 他の妖精の数だけ+1/+1", battlecry: { type: "buff_self_per_race_count", race: "fairy", atkPerAlly: 1, hpPerAlly: 1, target: "none" } },
    // legendary
