...
export const EXPANSION_CARDS = {
  ...
  fairy: [
    ...
    { id: "fa_r6", name: "踊る妖精姫", emoji: "💃", cost: 4, type: "minion", atk: 1, hp: 1, keywords: ["charge"], race: "fairy", rarity: "rare", set: "fairy", text: "速攻。戦場に出た時: 他の妖精の数だけ+2/+2", battlecry: { type: "buff_self_per_race_count", race: "fairy", atkPerAlly: 2, hpPerAlly: 2, target: "none" } },
    // epic
    ...
    { id: "fa_e2", name: "大妖精", emoji: "🧚‍♀️", cost: 6, type: "minion", atk: 3, hp: 4, keywords: [], race: "fairy", rarity: "epic", set: "fairy", costReducePerRace: { race: "fairy", cap: 3 }, text: "自分の妖精の数だけコストが下がる（最大3）。戦場に出た時: 1/1の妖精のかけらを2体呼び出し、他の妖精の数だけ+1/+1", battlecry: { type: "summon_token_and_buff_self", token: "fairy_token", count: 2, race: "fairy", atkPerAlly: 1, hpPerAlly: 1, target: "none" } },
  ...
  evolution: [
    ...
    { id: "ev_r3", name: "進化の秘術師", emoji: "🧙", cost: 4, type: "minion", atk: 3, hp: 4, keywords: [], rarity: "rare", set: "evolution", text: "戦場に出た時: デッキから進化カードを1枚ランダムに手札に加える", battlecry: { type: "tutor_random_evolve", target: "none" } },
    ...
    { id: "ev_l1", name: "古龍神ヴォルカドラゴン", emoji: "🌋🐲", cost: 8, type: "minion", atk: 8, hp: 8, keywords: ["taunt"], race: "dragon", rarity: "legendary", set: "evolution", evolve: { race: "dragon" }, text: "進化－竜。挑発。進化時: 敵にランダムに3ダメージを3回与える（ミニオンか顔面のどちらかにランダムで命中）", battlecry: { type: "random_burst", value: 3, hits: 3, target: "none" } },
